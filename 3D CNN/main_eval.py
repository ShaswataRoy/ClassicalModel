...
parser.add_argument(
    "--csv-fn", default="core_test_3dnn.csv", help="csv file path")
parser.add_argument(
    "--mlhdf-fn", default="pdbbind2016_core_test.hdf", help="ml-hdf path")
parser.add_argument("--model-path", default="../cheatings/model_3dcnn_02.pth", help="model checkpoint file path")
parser.add_argument("--complex-type", type=int, default=1, help="1: crystal, 2: docking")
parser.add_argument("--rmsd-threshold", type=float, default=100, help="rmsd cut-off threshold in case of docking data and/or --rmsd-weight is true")
